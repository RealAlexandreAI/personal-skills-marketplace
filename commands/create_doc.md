...
## Function
Create comprehensive documentation following Diátaxis framework

## Trigger Condition
When user inputs `/create-doc`

## Behavior
Guide users through creating documentation that follows Diátaxis framework principles
...
- `doc/tutorial` for learning-oriented content
- `doc/howto` for task-oriented content
- `doc/reference` for information-oriented content
- `doc/explanation` for understanding-oriented content
